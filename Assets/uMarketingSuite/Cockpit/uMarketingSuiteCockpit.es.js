...
const useGlobalState = createGlobalState(() => useStorage("umsCockpit", {
  page: {
    id: null,
    culture: null
  },
  ...
  simulation: {
    running: false,
    segments: [],
    cookieName: "umsSimulatedSegments"
  },
  ui: {
    open: false,
    position: "left",
...
var UmsIcon_vue_vue_type_style_index_0_scoped_true_lang = "";
...
const _sfc_main$k = {
  ...
  setup(__props) {
    ...
    const getIcon = () => {
      switch (props.icon) {
        case "logo-small":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.348 150">
                        <defs />
                        <path fill="#384a9a" d="M88.754 116.454a39.034 39.034 0 01-66.613-27.6v-33.5a5.847 5.847 0 1111.693 0v33.5a27.3165 27.3165 0 1054.633 0v-33.69a5.847 5.847 0 1111.693 0v33.69a38.9 38.9 0 01-11.406 27.6z" />
                        <path fill="#e73f29" d="M73.131 100.783a16.707 16.707 0 01-11.933 4.936 16.945 16.945 0 01-16.917-16.917V77.348a5.847 5.847 0 1111.693 0v11.454a5.236 5.236 0 005.224 5.224 5.146 5.146 0 003.69-1.534 5.146 5.146 0 001.534-3.69V45.475a17.333 17.333 0 014.84-12.029 16.69 16.69 0 0112.029-5.171 16.336 16.336 0 019.441 2.971c.335.24.671.479 1.006.767a5.86015 5.86015 0 01-7.38 9.105 2.029 2.029 0 00-.335-.24 5 5 0 00-2.78-.911 5.368 5.368 0 00-5.128 5.463v43.323a16.925 16.925 0 01-4.984 12.029z" />
                        <path fill="#31b297" d="M54.253 61.629a5.829 5.829 0 01-9.968-4.121V29.377a27.226 27.226 0 00-8-19.361 5.862622 5.862622 0 118.291-8.291 38.832 38.832 0 0111.454 27.6V57.46a6.063 6.063 0 01-1.777 4.169z" />
                        <path fill="#f5c1bc" d="M120.575 61.871a5.829 5.829 0 01-9.968-4.121V34.22a5.847 5.847 0 0111.693 0v23.53a5.877 5.877 0 01-1.725 4.121z" />
                        <path fill="#31b297" d="M104.378 132.125a61.06 61.06 0 01-85.3 1.006 5.864178 5.864178 0 118.1-8.482 49.37 49.37 0 0068.962-.863l.048-.048a49.113 49.113 0 0014.467-34.984V77.301a5.847 5.847 0 1111.693 0v11.453a61.214 61.214 0 01-17.971 43.371z" />
                        <path fill="#f5c1bc" d="M16.438 118.898a6.24 6.24 0 01-1.39 1.054 5.819 5.819 0 01-7.907-2.444A61.471 61.471 0 010 88.85V33.642a17.018 17.018 0 014.936-11.981 16.869 16.869 0 0128.8 11.981v1.965a5.847 5.847 0 01-11.693 0v-1.965a5.224 5.224 0 00-10.447 0V88.85a49.334 49.334 0 005.751 23.195 5.571 5.571 0 01-.909 6.853z" />
                    </svg>`;
        case "logo":
          return `<svg class="${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 527.615 86.984">
                        <defs />
                        <g fill="#20274d" data-name="Group 196">
                            <path d="M129.107 37.967v29.674h-4.894a1.857 1.857 0 01-1.942-1.4l-.544-2.1c-.621.544-1.243 1.088-1.864 1.554a17.557 17.557 0 01-2.02 1.243 10.26 10.26 0 01-2.33.777 14.525 14.525 0 01-2.719.311 10.476 10.476 0 01-4.273-.855 8.687 8.687 0 01-3.185-2.33 10.557 10.557 0 01-1.941-3.574 14.046 14.046 0 01-.7-4.506V37.967h7.924v18.8a5.579 5.579 0 001.165 3.806 4.068 4.068 0 003.34 1.4 7.008 7.008 0 003.107-.7 9.846 9.846 0 002.8-2.02V37.967h8.079z" data-name="Path 365" />
                            <path d="M182.319 25.849v41.715h-7.613V41.929a13.17 13.17 0 01.078-1.709 15.082 15.082 0 01.155-1.864l-11.963 22.605a3.153 3.153 0 01-3.03 1.864h-1.243a3.4 3.4 0 01-1.787-.466 3.134 3.134 0 01-1.243-1.4l-11.962-22.681c.078.7.078 1.321.155 1.942 0 .621.078 1.165.078 1.709v25.635h-7.613V25.849h7.535a2.3 2.3 0 01.777.155 2.725 2.725 0 01.621.388 3.348 3.348 0 01.544.777l11.652 22.217c.388.7.7 1.4 1.01 2.1s.621 1.4.932 2.175c.311-.777.621-1.476.932-2.253.311-.7.621-1.4 1.01-2.1l11.575-22.139a6.712 6.712 0 01.544-.777 1.691 1.691 0 01.621-.388 2.3 2.3 0 01.777-.155h7.457z" data-name="Path 366" />
                            <path d="M188.613 42.085a17.593 17.593 0 015.748-3.5 19.743 19.743 0 016.836-1.165 12.882 12.882 0 014.739.854 10.367 10.367 0 013.573 2.408 11.572 11.572 0 012.253 3.651 12.764 12.764 0 01.777 4.661v18.644h-3.651a3.352 3.352 0 01-1.709-.311 2.238 2.238 0 01-.932-1.321l-.621-1.864c-.777.621-1.476 1.243-2.175 1.709a12.1 12.1 0 01-2.175 1.243 12.462 12.462 0 01-2.408.777 15.939 15.939 0 01-2.874.233 10.458 10.458 0 01-3.573-.544 7.045 7.045 0 01-2.8-1.554 6.65 6.65 0 01-1.787-2.563 9.678 9.678 0 01-.621-3.5 7.3 7.3 0 01.854-3.263 7.406 7.406 0 012.874-2.952 17.969 17.969 0 015.438-2.175 35.552 35.552 0 018.467-1.01v-1.554a6.061 6.061 0 00-1.165-4.117 4.444 4.444 0 00-3.418-1.321 8.776 8.776 0 00-2.719.388 11.235 11.235 0 00-1.942.854c-.544.311-1.088.544-1.554.854a3.611 3.611 0 01-1.631.388 2.683 2.683 0 01-1.4-.388 3.8 3.8 0 01-.932-1.01zm16.158 13.128a34.81 34.81 0 00-4.816.466 10 10 0 00-3.03.932 4.168 4.168 0 00-1.631 1.321 2.872 2.872 0 00-.466 1.631 2.791 2.791 0 00.932 2.408 4.535 4.535 0 002.719.7 7.663 7.663 0 003.418-.7 10.024 10.024 0 002.874-2.175z" data-name="Path 367" />
                            <path d="M226.131 42.862a12.064 12.064 0 013.263-3.962 6.565 6.565 0 014.35-1.476 5.406 5.406 0 013.263.932l-.544 5.9a1.119 1.119 0 01-.466.777 1.4 1.4 0 01-.855.233 11.6 11.6 0 01-1.321-.155 11.59 11.59 0 00-1.631-.155 5.1 5.1 0 00-1.942.311 6.7 6.7 0 00-1.476.854 5.087 5.087 0 00-1.165 1.4 10.543 10.543 0 00-1.01 1.864v18.178h-7.923V37.89h4.661a2.151 2.151 0 011.631.466 2.909 2.909 0 01.7 1.476z" data-name="Path 368" />
                            <path d="M248.271 24.761v24.314h1.321a2.194 2.194 0 002.02-1.01l6.525-8.778a3.317 3.317 0 011.088-1.01 3.081 3.081 0 011.554-.311h7.224l-8.545 10.8a7.344 7.344 0 01-2.33 2.1 5.229 5.229 0 011.165 1.088c.311.388.621.855.932 1.321l9.167 14.286h-7.147a3.081 3.081 0 01-1.554-.311 2.448 2.448 0 01-1.088-1.088l-6.681-10.875a1.514 1.514 0 00-.855-.855 2.866 2.866 0 00-1.321-.233h-1.631v13.362h-7.923v-42.8z" data-name="Path 369" />
                            <path d="M276.625 53.97c.233 2.8 1.01 4.816 2.408 6.059a7.56 7.56 0 005.2 1.942 9.712 9.712 0 002.8-.388 13.1 13.1 0 002.1-.854c.621-.311 1.165-.621 1.631-.855a3.484 3.484 0 011.476-.388 1.8 1.8 0 011.476.7l2.331 2.874a11.54 11.54 0 01-2.8 2.408 17.237 17.237 0 01-3.185 1.554 16.074 16.074 0 01-3.34.777 22.791 22.791 0 01-3.185.233 15.839 15.839 0 01-5.826-1.01 13.435 13.435 0 01-4.661-3.03 14.052 14.052 0 01-3.185-4.972 18.534 18.534 0 01-1.165-6.836 15.3 15.3 0 011.01-5.671 13.737 13.737 0 017.38-7.846 15.054 15.054 0 016.059-1.165 14.817 14.817 0 015.282.932 11.374 11.374 0 014.117 2.641 11.523 11.523 0 012.719 4.272 16.524 16.524 0 01.932 5.748 8.016 8.016 0 01-.078 1.476 2.622 2.622 0 01-.311.932 1.045 1.045 0 01-.544.466 2.793 2.793 0 01-.855.155h-17.786zm12.507-4.661a7.362 7.362 0 00-.311-2.33 5.116 5.116 0 00-1.088-2.02 6.5 6.5 0 00-1.787-1.4 6.7 6.7 0 00-2.641-.466 5.864 5.864 0 00-4.428 1.631 8.139 8.139 0 00-2.1 4.583z" data-name="Path 370" />
                            <path d="M331.702 67.564h-7.926V43.638H310.65v15.459a2.907 2.907 0 00.621 1.942 2.063 2.063 0 001.709.7 3.936 3.936 0 001.01-.155 2.76 2.76 0 00.7-.311c.155-.078.388-.233.544-.311a1.1 1.1 0 01.466-.155 1.123 1.123 0 01.544.155 1.685 1.685 0 01.466.544l2.408 3.806a10.683 10.683 0 01-3.729 1.942 13.311 13.311 0 01-4.272.7 10.117 10.117 0 01-3.573-.621 6.758 6.758 0 01-2.641-1.709 7.588 7.588 0 01-1.631-2.641 9.723 9.723 0 01-.544-3.5v-16h-2.8a1.856 1.856 0 01-1.088-.388 1.529 1.529 0 01-.466-1.243v-3.107l4.739-.854 1.631-7.691a1.646 1.646 0 011.787-1.321h4.117v9.011H331.7zm1.243-38.064a5.34 5.34 0 01-.388 1.864 4.333 4.333 0 01-1.088 1.554 4.857 4.857 0 01-1.554 1.01 5.409 5.409 0 01-1.939.388 5.093 5.093 0 01-3.418-1.4 5.58 5.58 0 01-1.088-1.554 5 5 0 01-.388-1.864 4.694 4.694 0 01.388-1.864 4.334 4.334 0 011.088-1.554 5.58 5.58 0 011.554-1.088 5 5 0 011.864-.386 5.409 5.409 0 011.942.388 3.752 3.752 0 011.554 1.088 5.579 5.579 0 011.088 1.554 4.694 4.694 0 01.384 1.864z" data-name="Path 371" />
                            <path d="M345.839 41.385c.621-.544 1.243-1.088 1.865-1.554a17.562 17.562 0 012.02-1.243 10.265 10.265 0 012.33-.777 14.526 14.526 0 012.719-.311 10.475 10.475 0 014.272.855 8.688 8.688 0 013.185 2.33 10.561 10.561 0 011.942 3.573 14.053 14.053 0 01.621 4.506v18.8h-7.923v-18.8a5.578 5.578 0 00-1.165-3.806 4.127 4.127 0 00-3.418-1.4 7.008 7.008 0 00-3.107.7 9.845 9.845 0 00-2.8 2.02v21.285h-7.921V37.889h4.894a2.006 2.006 0 012.02 1.4z" data-name="Path 372" />
                            <path d="M397.498 38.901v2.874a1.537 1.537 0 01-.388 1.088 3.076 3.076 0 01-1.243.621l-2.408.466a9.525 9.525 0 01.466 3.03 8.286 8.286 0 01-.932 3.962 9.286 9.286 0 01-2.486 3.03 12.161 12.161 0 01-3.729 1.942 14.678 14.678 0 01-4.661.7 17.5 17.5 0 01-2.952-.233c-.777.466-1.243 1.01-1.243 1.631a1.412 1.412 0 00.854 1.243 6.8 6.8 0 002.175.544c.854.078 1.942.155 3.03.233 1.165 0 2.331.078 3.5.155a26.949 26.949 0 013.5.466 8.807 8.807 0 013.03 1.165 6.472 6.472 0 012.175 2.175 6.847 6.847 0 01.854 3.5 7.839 7.839 0 01-1.01 3.884 11.264 11.264 0 01-2.8 3.34 12.741 12.741 0 01-4.586 2.324 18.914 18.914 0 01-6.137.854 25.975 25.975 0 01-5.9-.621 16.249 16.249 0 01-4.195-1.709 7.587 7.587 0 01-2.486-2.486 5.793 5.793 0 01-.777-2.952 4.7 4.7 0 011.243-3.34 8.068 8.068 0 013.34-2.175 5.181 5.181 0 01-1.787-1.631 4.606 4.606 0 01-.7-2.641 5.422 5.422 0 01.932-2.8 6.63 6.63 0 012.952-2.408 9.054 9.054 0 01-3.573-3.263 8.675 8.675 0 01-1.321-4.739 8.287 8.287 0 01.932-3.962 10.385 10.385 0 012.486-3.03 11.737 11.737 0 013.806-1.942 15.53 15.53 0 014.739-.7 14.115 14.115 0 016.681 1.476h8.623zm-7.924 29.908a1.64 1.64 0 00-.466-1.243 3.14 3.14 0 00-1.321-.777 10.68 10.68 0 00-1.942-.388c-.777-.078-1.554-.155-2.408-.233s-1.709-.078-2.641-.155a14.529 14.529 0 01-2.641-.233 4.855 4.855 0 00-1.631 1.4 2.712 2.712 0 00-.621 1.864 2.553 2.553 0 00.311 1.321 2.742 2.742 0 001.088 1.01 6.132 6.132 0 002.02.7 17.824 17.824 0 003.185.233 20.423 20.423 0 003.34-.233 6.5 6.5 0 002.175-.7 2.8 2.8 0 001.165-1.165 2.12 2.12 0 00.387-1.403zm-7.458-17.168a4.547 4.547 0 003.573-1.243 4.471 4.471 0 001.165-3.185 4.224 4.224 0 00-1.165-3.185 6.062 6.062 0 00-7.147 0 4.345 4.345 0 00-1.165 3.185 4.471 4.471 0 001.167 3.188 4.547 4.547 0 003.573 1.238z" data-name="Path 373" />
                            <path d="M425.23 33.85a2.025 2.025 0 01-.854.932 1.644 1.644 0 01-1.088.311 2.949 2.949 0 01-1.4-.466 16.948 16.948 0 00-1.709-.932 12.3 12.3 0 00-2.253-.932 8.719 8.719 0 00-2.952-.466 6.778 6.778 0 00-4.505 1.321 4.31 4.31 0 00-1.476 3.5 3.109 3.109 0 00.854 2.253 6.8 6.8 0 002.175 1.554 13.7 13.7 0 003.03 1.165 36.844 36.844 0 013.5 1.165 33.547 33.547 0 013.5 1.476 10.547 10.547 0 013.03 2.1 10.13 10.13 0 012.175 3.107 10.974 10.974 0 01.854 4.428 13.988 13.988 0 01-1.01 5.36 13.694 13.694 0 01-2.874 4.35 14.552 14.552 0 01-4.583 2.952 15.573 15.573 0 01-6.214 1.088 22.817 22.817 0 01-3.962-.388 21.332 21.332 0 01-3.806-1.088 23.385 23.385 0 01-3.418-1.709 13.654 13.654 0 01-2.8-2.253l2.563-4.117a2.771 2.771 0 01.854-.777 1.942 1.942 0 011.088-.311 2.736 2.736 0 011.631.544c.544.388 1.243.777 2.02 1.243a19.66 19.66 0 002.564 1.243 9.882 9.882 0 003.573.544 6.959 6.959 0 004.661-1.4 5.053 5.053 0 001.631-4.117 3.775 3.775 0 00-.854-2.564A6.938 6.938 0 00417 51.335a13.7 13.7 0 00-3.03-1.165c-1.165-.311-2.253-.7-3.5-1.01a32.78 32.78 0 01-3.5-1.4 10.549 10.549 0 01-3.03-2.1 9.993 9.993 0 01-2.175-3.263 12.846 12.846 0 01-.854-4.894 11.418 11.418 0 01.932-4.506 11.027 11.027 0 012.719-3.884 12.951 12.951 0 014.35-2.719 15.833 15.833 0 015.987-1.011 20.634 20.634 0 016.991 1.165 15.169 15.169 0 015.438 3.263z" data-name="Path 374" />
                            <path d="M458.789 37.967v29.674h-4.894a1.857 1.857 0 01-1.942-1.4l-.544-2.1c-.621.544-1.243 1.088-1.864 1.554a17.552 17.552 0 01-2.02 1.243 10.26 10.26 0 01-2.33.777 14.525 14.525 0 01-2.719.311 10.476 10.476 0 01-4.273-.855 8.688 8.688 0 01-3.185-2.33 10.558 10.558 0 01-1.941-3.574 14.047 14.047 0 01-.7-4.506V37.967h7.924v18.8a5.578 5.578 0 001.165 3.806 4.068 4.068 0 003.34 1.4 7.008 7.008 0 003.107-.7 9.846 9.846 0 002.8-2.02V37.967h8.079z" data-name="Path 375" />
                            <path d="M474.481 29.5a4.7 4.7 0 01-.388 1.864 5.132 5.132 0 01-1.088 1.554 4.856 4.856 0 01-1.554 1.01 5.409 5.409 0 01-1.942.388 5.093 5.093 0 01-3.418-1.4 5.582 5.582 0 01-1.088-1.554 4.668 4.668 0 010-3.729 4.333 4.333 0 011.088-1.554 4.139 4.139 0 011.554-1.01 5 5 0 011.864-.388 5.408 5.408 0 011.942.388 4.488 4.488 0 011.554 1.01 5.583 5.583 0 011.088 1.554 5.341 5.341 0 01.388 1.867zm-1.01 8.467v29.674h-7.924V37.968z" data-name="Path 376" />
                            <path d="M490.561 68.03a10.118 10.118 0 01-3.573-.621 6.758 6.758 0 01-2.641-1.709 7.586 7.586 0 01-1.631-2.641 9.721 9.721 0 01-.544-3.5v-16h-2.8a1.856 1.856 0 01-1.088-.388 1.529 1.529 0 01-.466-1.243v-3.107l4.739-.854 1.631-7.691a1.646 1.646 0 011.787-1.321h4.117v9.011h7.613v5.515h-7.613V58.94a2.907 2.907 0 00.621 1.942 2.063 2.063 0 001.709.7 3.935 3.935 0 001.01-.155 2.76 2.76 0 00.7-.311c.155-.078.388-.233.544-.311a1.1 1.1 0 01.466-.155 1.123 1.123 0 01.544.155 1.685 1.685 0 01.466.544l2.408 3.806a10.683 10.683 0 01-3.729 1.942 9.241 9.241 0 01-4.27.933z" data-name="Path 377" />
                            <path d="M508.039 53.97c.233 2.8 1.01 4.816 2.408 6.059a7.559 7.559 0 005.2 1.942 9.711 9.711 0 002.8-.388 13.094 13.094 0 002.1-.854c.622-.311 1.165-.621 1.631-.855a3.484 3.484 0 011.476-.388 1.8 1.8 0 011.476.7l2.33 2.874a11.54 11.54 0 01-2.8 2.408 17.241 17.241 0 01-3.185 1.554 16.073 16.073 0 01-3.34.777 22.793 22.793 0 01-3.185.233 15.839 15.839 0 01-5.826-1.01 13.434 13.434 0 01-4.661-3.03 14.053 14.053 0 01-3.185-4.972 18.533 18.533 0 01-1.165-6.836 15.3 15.3 0 011.01-5.671 13.736 13.736 0 017.38-7.846 15.053 15.053 0 016.059-1.165 14.817 14.817 0 015.282.932 11.375 11.375 0 014.117 2.641 11.522 11.522 0 012.719 4.272 16.522 16.522 0 01.932 5.748 8.013 8.013 0 01-.078 1.476 2.62 2.62 0 01-.311.932 1.045 1.045 0 01-.544.466 2.793 2.793 0 01-.854.155h-17.786zm12.507-4.661a7.358 7.358 0 00-.311-2.33 5.116 5.116 0 00-1.087-2.02 6.5 6.5 0 00-1.787-1.4 6.7 6.7 0 00-2.641-.466 5.864 5.864 0 00-4.428 1.631 8.14 8.14 0 00-2.1 4.583z" data-name="Path 378" />
                        </g>
                        <g data-name="Group 198">
                            <g data-name="Group 197">
                                <path fill="#384a9a" d="M51.426 67.487a22.605 22.605 0 01-38.608-16V32.068a3.418 3.418 0 016.836 0v19.42a15.433 15.433 0 004.664 11.18 15.7 15.7 0 0011.186 4.661 15.914 15.914 0 0015.847-15.847v-19.5a3.418 3.418 0 116.836 0v19.5a23.4 23.4 0 01-6.761 16.005z" data-name="Path 379" />
                            </g>
                        </g>
                        <g data-name="Group 200">
                            <g data-name="Group 199">
                                <path fill="#e73f29" d="M42.335 58.471a9.631 9.631 0 01-6.914 2.874 9.8 9.8 0 01-9.788-9.788v-6.681a3.418 3.418 0 016.836 0v6.681a3.033 3.033 0 003.03 3.03 3 3 0 002.1-.855 3.051 3.051 0 00.855-2.175V26.392a10.211 10.211 0 012.8-6.991 9.648 9.648 0 016.991-3.03 10.04 10.04 0 015.515 1.709c.233.155.388.311.621.466a3.367 3.367 0 11-4.272 5.2c-.078-.078-.155-.078-.155-.155a2.885 2.885 0 00-1.631-.544 3.107 3.107 0 00-2.952 3.185v25.091a10.728 10.728 0 01-3.036 7.148z" data-name="Path 380" />
                            </g>
                        </g>
                        <g data-name="Group 202">
                            <g data-name="Group 201">
                                <path fill="#31b297" d="M31.381 35.714a3.408 3.408 0 01-2.408 1.01 3.448 3.448 0 01-3.418-3.418V16.993a15.433 15.433 0 00-4.661-11.186A3.406 3.406 0 0125.71.991a22.439 22.439 0 016.6 16v16.315a3.052 3.052 0 01-.929 2.408z" data-name="Path 381" />
                            </g>
                        </g>
                        <g data-name="Group 204">
                            <g data-name="Group 203">
                                <path fill="#f5c1bc" d="M69.836 35.871a3.408 3.408 0 01-2.408 1.01 3.448 3.448 0 01-3.418-3.42V19.789a3.418 3.418 0 116.836 0v13.672a3.408 3.408 0 01-1.01 2.41z" data-name="Path 382" />
                            </g>
                        </g>
                        <g data-name="Group 206">
                            <g data-name="Group 205">
                                <path fill="#31b297" d="M60.436 76.575a35.368 35.368 0 01-49.483.621 3.407554 3.407554 0 114.661-4.972 28.613 28.613 0 0040.006-.466 28.5 28.5 0 008.39-20.275v-6.681a3.418 3.418 0 116.836 0v6.683a35 35 0 01-10.409 25.091z" data-name="Path 383" />
                            </g>
                        </g>
                        <g data-name="Group 208">
                            <g data-name="Group 207">
                                <path fill="#f5c1bc" d="M9.477 68.962a3.042 3.042 0 01-.777.621 3.427 3.427 0 01-4.583-1.4A35.127 35.127 0 010 51.561v-32a9.631 9.631 0 012.874-6.914 9.752 9.752 0 0113.827 0 9.763 9.763 0 012.874 6.914v1.165a3.418 3.418 0 01-6.836 0v-1.17a3.03 3.03 0 00-6.059 0v32a28.931 28.931 0 003.34 13.439 3.3 3.3 0 01-.543 3.967z" data-name="Path 384" />
                            </g>
                        </g>
                    </svg>`;
        case "nav-hamburger":
          return ` <svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.169 11.5"> <path fill="none" stroke="#1a254f" stroke-linecap="round" stroke-width="1.5" d="M.75.75h14.669M.75 5.75h14.669M.75 10.75h14.669" /> </svg>`;
        case "panel-align":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
                        <defs />
        ...
        case "close":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10">
                        <defs/>
        ...
        case "back":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12.994 11.61">
                        <defs/>
        ...
        case "external-link":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" data-name="Group 3610" viewBox="0 0 10 10">
                        <defs/>
                        <g fill="currentColor">
        ...
        case "arrow":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.126 6.749">
                        <defs/>
        ...
        case "arrow-light":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.319 5.033">
                        <defs/>
        ...
        case "delete":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.364 10">
                        <defs/>
                        <g fill="currentColor">
        ...
        case "umbraco":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <defs />
        ...
        case "analytics":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
                        <defs />
        ...
        case "abtest":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.242 18">
                        <defs/>
        ...
        case "pilotcap":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 14.125">
                        <defs/>
        ...
        case "ecommerce":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
                        <defs/>
        ...
        case "explicit":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28">
                        <defs/>
        ...
        case "goals":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34">
                        <defs/>
        ...
        case "persona":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.502 17">
        ...
        case "browser":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <defs/>
        ...
        case "device":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <defs/>
        ...
        case "logged-members":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        ...
        case "status-running":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
        ...
        case "info":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 13">
        ...
        case "checkmark-boxed":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15">
        ...
        case "profile":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
        ...
        case "page-events":
          return `<svg class="ums-front-icon ${props.customclass}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.252 13.25">
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        innerHTML: getIcon(),
        class: "ums-cockpit-icon-host"
      }, null, 8, _hoisted_1$h);
    };
  }
};
var UmsIcon = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-5b2f6a0d"]]);
var UmsCockpitBadge_vue_vue_type_style_index_0_scoped_true_lang = "";
const _withScopeId$2 = (n) => (pushScopeId("data-v-5e577f4e"), n = n(), popScopeId(), n);
const _hoisted_1$g = { class: "ums-c-badge-logo" };
const _hoisted_2$c = { class: "ums-c-badge-button" };
const _hoisted_3$b = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("span", null, [
  /* @__PURE__ */ createTextVNode("Open "),
  /* @__PURE__ */ createBaseVNode("span", { class: "vh" }, "uMarketingSuite cockpit")
], -1));
const _sfc_main$j = {
  props: {
    position: {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        type: "button",
        class: normalizeClass(["ums-c-badge", { "s-right": __props.position === "right" }]),
        onClick: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("on-open"))
      }, [
        createBaseVNode("div", _hoisted_1$g, [
          createVNode(UmsIcon, {
            icon: "logo-small",
            customclass: "ums-front-icon--logo-image"
          })
        ]),
        createBaseVNode("div", _hoisted_2$c, [
          createVNode(UmsIcon, {
            icon: "nav-hamburger",
            customclass: "ums-front-icon--sm ums-front-cockpit__badge__button__icon"
          }),
          _hoisted_3$b
        ])
      ], 2);
...
var UmsCockpitBadge = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-5e577f4e"]]);
var UmsCockpitNav_vue_vue_type_style_index_0_scoped_true_lang = "";
const _withScopeId$1 = (n) => (pushScopeId("data-v-2e64eae2"), n = n(), popScopeId(), n);
const _hoisted_1$f = { class: "ums-c-main-navlist" };
const _hoisted_2$b = {
  key: 0,
  class: "ums-c-main-navitem"
};
const _hoisted_3$a = { class: "ums-c-navitem-icon" };
const _hoisted_4$9 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("span", { class: "ums-c-navitem-title" }, "Analytics", -1));
const _hoisted_5$9 = {
  key: 1,
  class: "ums-c-main-navitem"
};
const _hoisted_6$9 = { class: "ums-c-navitem-icon" };
const _hoisted_7$9 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("span", { class: "ums-c-navitem-title" }, "Personalization", -1));
const _hoisted_8$9 = { class: "ums-c-main-navitem" };
const _hoisted_9$7 = { class: "ums-c-navitem-icon" };
const _hoisted_10$6 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("span", { class: "ums-c-navitem-title" }, "My Profile", -1));
const _hoisted_11$5 = { class: "ums-c-main-navitem" };
const _hoisted_12$3 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("span", { class: "ums-c-navitem-title" }, "Simulation mode", -1));
const _hoisted_13$2 = {
  key: 0,
  class: "ums-c-navitem-sub s-active s-blink"
};
const _hoisted_14$2 = { class: "ums-c-main-navitem" };
const _hoisted_15$2 = { class: "ums-c-navitem-icon" };
const _hoisted_16$2 = { class: "ums-c-rounded-icon" };
const _hoisted_17$2 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("span", { class: "ums-c-navitem-title" }, "Umbraco page info", -1));
const _sfc_main$i = {
  props: {
    small: {
      type: Boolean,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("nav", {
        class: normalizeClass(["ums-c-main-nav", { "s-small": __props.small }])
      }, [
        createBaseVNode("ul", _hoisted_1$f, [
          unref(state).licenseStatus.FeatureAnalyticsEnabled ? (openBlock(), createElementBlock("li", _hoisted_2$b, [
            createBaseVNode("button", {
              class: normalizeClass(["ums-c-main-navbutton", { "s-active": unref(state).ui.activePanel === "analytics" }]),
              onClick: _cache[0] || (_cache[0] = ($event) => setActivePanel("analytics"))
            }, [
              createBaseVNode("span", _hoisted_3$a, [
                createVNode(UmsIcon, {
                  icon: "analytics",
                  customclass: "ums-front-icon--md"
                })
              ]),
              _hoisted_4$9
            ], 2)
          ])) : createCommentVNode("", true),
          unref(state).licenseStatus.FeaturePersonalizationEnabled ? (openBlock(), createElementBlock("li", _hoisted_5$9, [
            createBaseVNode("button", {
              class: normalizeClass(["ums-c-main-navbutton", { "s-active": unref(state).ui.activePanel === "personalization" }]),
          ...
          createBaseVNode("li", _hoisted_8$9, [
            createBaseVNode("button", {
              class: normalizeClass(["ums-c-main-navbutton", { "s-active": unref(state).ui.activePanel === "profile" }]),
          ...
          createBaseVNode("li", _hoisted_11$5, [
            createBaseVNode("button", {
              class: normalizeClass(["ums-c-main-navbutton", { "s-active": unref(state).ui.activePanel === "simulationmode" }]),
              onClick: _cache[3] || (_cache[3] = ($event) => setActivePanel("simulationmode"))
            }, [
              createBaseVNode("span", {
                class: normalizeClass(["ums-c-navitem-icon", { "s-bullet-active s-blink": __props.small && unref(state).simulation.running }])
              }, [
                createVNode(UmsIcon, {
                  icon: "pilotcap",
                  customclass: "ums-front-icon--md"
              ...
              _hoisted_12$3,
              unref(state).simulation.running ? (openBlock(), createElementBlock("span", _hoisted_13$2, " Active ")) : createCommentVNode("", true)
            ], 2)
          ]),
          createBaseVNode("li", _hoisted_14$2, [
            createBaseVNode("button", {
              class: normalizeClass(["ums-c-main-navbutton", { "s-active": unref(state).ui.activePanel === "pageinfo" }]),
              onClick: _cache[4] || (_cache[4] = ($event) => setActivePanel("pageinfo"))
            }, [
...
var UmsCockpitNav = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-2e64eae2"]]);
var UmsButton_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$h = {
  props: {
    label: {
      type: String
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(unref(componentTag)), mergeProps({
        class: ["ums-front-cockpit__button", [
          __props.look,
          { "ums-front-icon__wrap": __props.icon, "icon-right": __props.iconFlip, "is-loading": __props.isLoading }
        ]],
        href: unref(to),
        ...
        default: withCtx(() => [
          ...
          __props.icon ? (openBlock(), createBlock(UmsIcon, {
            key: 0,
            icon: __props.icon,
            customclass: "ums-front-icon--xs"
...
var UmsButton = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-766792b9"]]);
var CockpitPanel_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$g = {};
const _hoisted_1$e = { class: "ums-c-panel" };
function _sfc_render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$e, [
    renderSlot(_ctx.$slots, "default", {}, void 0, true)
  ]);
}
var CockpitPanel = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$2], ["__scopeId", "data-v-1d44a0ea"]]);
const _hoisted_1$d = { key: 0 };
const _hoisted_2$a = {
  key: 1,
  class: "ums-front-cockpit__panel__content"
};
const _hoisted_3$9 = { class: "ums-front-cockpit__panel__section" };
const _hoisted_4$8 = /* @__PURE__ */ createBaseVNode("span", { class: "ums-front-cockpit__panel__header" }, "Tracking", -1);
const _hoisted_5$8 = { class: "ums-front-cockpit__table-simple" };
const _hoisted_6$8 = /* @__PURE__ */ createBaseVNode("th", null, "Time on page:", -1);
...
const _hoisted_11$4 = { class: "ums-front-cockpit__panel__section" };
const _hoisted_12$2 = /* @__PURE__ */ createBaseVNode("span", { class: "ums-front-cockpit__panel__header" }, "Events", -1);
const _hoisted_13$1 = { class: "ums-front-cockpit__table-holder" };
const _hoisted_14$1 = { class: "ums-front-cockpit__table-extended" };
const _hoisted_15$1 = /* @__PURE__ */ createBaseVNode("thead", null, [
  /* @__PURE__ */ createBaseVNode("tr", { class: "ums-front-cockpit__grid-table" }, [
...
const _hoisted_17$1 = /* @__PURE__ */ createBaseVNode("tr", null, [
...
const _hoisted_24 = { class: "ums-front-cockpit__panel__section" };
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("span", { class: "ums-front-cockpit__panel__header" }, "Videos", -1);
const _hoisted_26 = { class: "ums-front-cockpit__table-holder" };
const _hoisted_27 = { class: "ums-front-cockpit__table-extended" };
...
const _hoisted_41 = { class: "ums-front-cockpit__table-extended" };
...
const _hoisted_46 = { class: "ums-front-cockpit__panel__section" };
const _hoisted_47 = { class: "ums-front-cockpit__infobullet__holder" };
const _hoisted_48 = /* @__PURE__ */ createBaseVNode("span", { class: "ums-front-cockpit__panel__header" }, "Click to non-pageviews", -1);
const _hoisted_49 = { class: "ums-front-cockpit__infobullet__item" };
const _hoisted_50 = /* @__PURE__ */ createBaseVNode("span", { class: "ums-front-cockpit__infobullet__text" }, "By default the uMarketingSuite measures clicks to external websites, clicks on mailto-links, tel-links, internal anchorlinks and clicks to .pdf, .doc and .docx", -1);
const _hoisted_51 = { class: "ums-front-cockpit__table-holder" };
const _hoisted_52 = { class: "ums-front-cockpit__table-extended" };
...
const _hoisted_58 = { class: "ums-blue" };
const _sfc_main$f = {
  setup(__props) {
    const data = ref(null);
    const updateDataTimeout = ref(null);
    const updateData = (nextTimeout) => {
      if (!window.uMarketingSuite || !window.uMarketingSuite.analytics) {
        console.error("The uMarketingSuite.analytics.js script has not been included. Please include the /Assets/uMarketingSuite/Scripts/uMarketingSuite.analytics.js to show client side data reporting.");
        return;
      }
      data.value = window.uMarketingSuite.analytics.getClientSideData();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(CockpitPanel, null, {
        default: withCtx(() => [
          data.value == null ? (openBlock(), createElementBlock("div", _hoisted_1$d, "Client side data reporting is not available.")) : createCommentVNode("", true),
          data.value != null ? (openBlock(), createElementBlock("div", _hoisted_2$a, [
            ...
            createBaseVNode("div", _hoisted_11$4, [
              ...
              createBaseVNode("div", _hoisted_13$1, [
                createBaseVNode("table", _hoisted_14$1, [
                  _hoisted_15$1,
                  data.value.events.length === 0 ? (openBlock(), createElementBlock("tbody", _hoisted_16$1, _hoisted_18$1)) : createCommentVNode("", true),
                  data.value.events.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(data.value.events, (event, index) => {
                    return openBlock(), createElementBlock("tbody", { key: index }, [
                      createBaseVNode("tr", null, [
                        createBaseVNode("td", {
                          class: "ums-blue ums-td-no-border",
                          colspan: "4",
                          title: "Event category: " + event.category
                        }, toDisplayString(event.category), 9, _hoisted_19$1)
                      ]),
                      createBaseVNode("tr", null, [
                        createBaseVNode("td", {
                          title: "Event action: " + event.action
                        }, toDisplayString(event.action), 9, _hoisted_20),
                        createBaseVNode("td", {
                          title: "Event label: " + event.label
                        }, toDisplayString(event.label), 9, _hoisted_21),
                        createBaseVNode("td", {
                          title: "Event value: " + event.value
                        }, toDisplayString(event.value), 9, _hoisted_22),
                        createBaseVNode("td", {
                          title: "Event interactive: " + event.interactive
                        }, toDisplayString(event.interactive), 9, _hoisted_23)
                      ])
                    ]);
                ...
                createBaseVNode("table", _hoisted_27, [
                  ...
                  data.value.videos.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(data.value.videos, (video, index) => {
                    return openBlock(), createElementBlock("tbody", { key: index }, [
                      createBaseVNode("tr", null, [
                        createBaseVNode("td", {
                          class: normalizeClass(["ums-td-no-border ums-bold", { "ums-blue": video.name }]),
                          title: "Name: " + video.name
                        }, toDisplayString(video.name || "No name"), 11, _hoisted_32),
                        createBaseVNode("td", {
                          class: "ums-td-no-border",
                          style: { "max-width": "100px" },
                          title: "URL: " + video.url
                        }, toDisplayString(video.url), 9, _hoisted_33),
                        createBaseVNode("td", {
                          class: "ums-td-no-border ums-small",
                              ...
                              (openBlock(true), createElementBlock(Fragment, null, renderList(video.events, (event, eventIndex) => {
                                return openBlock(), createElementBlock("tr", {
                                  ...
                                  class: normalizeClass({
                                    "ums-tr-no-border": eventIndex === video.events.length - 1
                                  })
                                }, [
                                  createBaseVNode("td", {
                                    title: "Event action: " + event.action
            ...
            createBaseVNode("div", _hoisted_46, [
              createBaseVNode("div", _hoisted_47, [
                ...
                createBaseVNode("span", _hoisted_49, [
                  createVNode(UmsIcon, {
                    icon: "info",
                    customclass: "ums-front-icon--xs ums-front-cockpit__infobullet__icon"
                  }),
                  _hoisted_50
                ])
              ]),
...
const _withScopeId = (n) => (pushScopeId("data-v-4d63c466"), n = n(), popScopeId(), n);
const _hoisted_1$c = { class: "ums-front-cockpit__panel__content" };
const _hoisted_2$9 = { class: "ums-front-cockpit__panel__section" };
const _hoisted_3$8 = { class: "ums-front-cockpit__table-simple" };
const _hoisted_4$7 = {
  key: 0,
  class: "ums-front-cockpit__link-holder ums-front-cockpit__popup__enter"
};
const _hoisted_5$7 = ["href"];
const _hoisted_6$7 = { class: "ums-front-cockpit__infobullet__item" };
const _hoisted_7$7 = { class: "ums-front-cockpit__infobullet__text ums-front-cockpit__infobullet__text--normal" };
const _hoisted_8$7 = { key: 1 };
const _hoisted_9$5 = { class: "ums-front-cockpit__panel__section" };
...
const _hoisted_12$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "ums-front-cockpit__popup__holder ums-front-cockpit__popup__holder--offset ums-front-cockpit__popup__holder--no-pointer is-animated" }, " Dismiss ", -1));
const _sfc_main$e = {
  setup(__props) {
    const data = ref(null);
    ...
    const getData = () => {
      const _data = window.__UMS_COCKPIT_DATA;
      if (_data != null && _data.analyticsServer != null) {
        data.value = _data.analyticsServer;
      }
    };
    const deleteCookie = () => {
      sendXhr("POST", "/umbraco/umarketingsuite/cockpitapi/DeleteCookie", cookieMessage);
    };
    const cookieMessage = () => {
        ...
        default: withCtx(() => [
          ...
          withDirectives(createBaseVNode("div", _hoisted_1$c, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(data.value, (row) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", null, [
                        isValidUrl(row.value) ? (openBlock(), createElementBlock("span", _hoisted_4$7, [
                          createBaseVNode("a", {
                            class: "ums-front-cockpit__link-item",
                            href: row.value,
                            target: "blank"
                          }, toDisplayString(row.value), 9, _hoisted_5$7),
            ...
            createBaseVNode("div", _hoisted_9$5, [
              createVNode(UmsButton, {
                label: "Delete uMarketingSuite cookie",
                look: "ums-front-cockpit__button--nobutton ums-front-cockpit__button--error ums-front-icon__wrap",
                icon: "delete",
              ...
              showCookieDeletedMessage.value ? (openBlock(), createElementBlock("div", _hoisted_10$4, [
                createBaseVNode("div", {
                  class: "ums-front-cockpit__message-box ums-front-cockpit__message-box--clickable ums-front-icon__wrap is-animated",
                  onClick: _cache[1] || (_cache[1] = ($event) => showCookieDeletedMessage.value = false)
                }, [
                  createVNode(UmsIcon, {
                    icon: "checkmark-boxed",
                    customclass: "ums-front-icon--sm"
                  }),
                  _hoisted_11$3
                ]),
                _hoisted_12$1
...
var AnalyticsServer = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-4d63c466"]]);
var CockpitSubpanelList_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$d = {};
const _hoisted_1$b = { class: "ums-c-subpanel-list" };
function _sfc_render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("ul", _hoisted_1$b, [
    renderSlot(_ctx.$slots, "default", {}, void 0, true)
  ]);
}
var CockpitSubpanelList = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$1], ["__scopeId", "data-v-44566984"]]);
var CockpitSubpanelHeader_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$a = { class: "ums-c-subheader__title" };
const _sfc_main$c = {
  props: {
    title: {
      type: String,
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        class: normalizeClass(["ums-c-subheader", { "s-selected": __props.selected }]),
        type: "button"
      }, [
        createBaseVNode("span", _hoisted_1$a, toDisplayString(__props.title), 1),
        createBaseVNode("span", {
          class: normalizeClass(["ums-c-subheader__caret", { "s-active": __props.selected }])
        }, [
          createVNode(UmsIcon, {
            icon: "caret",
            customclass: "ums-front-icon--xs"
...
var CockpitSubpanelHeader = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-3f66fcbd"]]);
var CockpitSubpanelItem_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$b = {};
const _hoisted_1$9 = { class: "ums-c-subpanel-item" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("li", _hoisted_1$9, [
    renderSlot(_ctx.$slots, "default", {}, void 0, true)
  ]);
}
var CockpitSubpanelItem = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render], ["__scopeId", "data-v-b56b1df6"]]);
const _sfc_main$a = {
  setup(__props) {
    const state = useGlobalState();
    return (_ctx, _cache) => {
        ...
        default: withCtx(() => [
          createVNode(CockpitSubpanelItem, null, {
            default: withCtx(() => [
              ...
              unref(state).ui.subPanels.analytics.client ? (openBlock(), createBlock(_sfc_main$f, { key: 0 })) : createCommentVNode("", true)
            ]),
            _: 1
          }),
          createVNode(CockpitSubpanelItem, null, {
...
const _hoisted_2$8 = /* @__PURE__ */ createBaseVNode("table", null, null, -1);
const _hoisted_3$7 = [
  _hoisted_2$8
];
const _hoisted_4$6 = { class: "ums-front-cockpit__chart-persona__list" };
const _hoisted_5$6 = { class: "ums-front-cockpit__chart-persona__icon-holder" };
const _hoisted_6$6 = { class: "ums-front-cockpit__chart-persona__image-holder" };
const _hoisted_7$6 = ["src"];
const _hoisted_8$6 = /* @__PURE__ */ createBaseVNode("span", { class: "ums-front-cockpit__chart-persona__empty-bar" }, null, -1);
const _hoisted_9$4 = { class: "ums-front-cockpit__chart-persona__legend-list" };
const _sfc_main$9 = {
  props: {
    group: {
      type: Object
  ...
  setup(__props) {
          ...
          external: function(context) {
            ...
            if (tooltipModel.body) {
              ...
              bodyLines.forEach(function(body, i) {
                ...
                var span = '<span class="ums-front-cockpit__chart-persona__tooltip-color" style="' + style2 + '"></span>';
    ...
    return (_ctx, _cache) => {
      return unref(items) ? (openBlock(), createElementBlock("div", _hoisted_1$8, [
        createVNode(unref(BarChart), mergeProps(unref(barChartProps), {
          ...
          class: "ums-front-cockpit__chart-persona__chart",
          style: [{ "position": "relative" }, { height: unref(chartHeight) }]
        }), null, 16, ["threshold", "difference", "style"]),
        createBaseVNode("div", {
          ref_key: "chartTooltip",
          ref: chartTooltip,
          class: "ums-front-cockpit__chart-persona__tooltip"
        }, _hoisted_3$7, 512),
        createBaseVNode("ul", _hoisted_4$6, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(items), (item) => {
            return openBlock(), createElementBlock("li", {
              class: "ums-front-cockpit__chart-persona__item",
              key: item.id
            }, [
              createBaseVNode("span", _hoisted_5$6, [
                createBaseVNode("span", {
                  class: "ums-front-cockpit__chart-persona__line",
                  style: normalizeStyle({ "background-color": item.color })
                }, null, 4),
                createBaseVNode("span", _hoisted_6$6, [
                  !item.iconUrl ? (openBlock(), createBlock(UmsIcon, {
                    key: 0,
                    icon: "personalization",
                    customclass: "ums-front-icon--md ums-front-cockpit__chart-persona__defaulticon"
                  })) : createCommentVNode("", true),
                  item.iconUrl ? (openBlock(), createElementBlock("img", {
                    key: 1,
                    src: item.iconUrl,
                    class: "ums-front-cockpit__chart-persona__icon"
                  }, null, 8, _hoisted_7$6)) : createCommentVNode("", true)
                ])
              ]),
              createBaseVNode("span", {
                class: normalizeClass(["ums-front-cockpit__chart-persona__name", { "s-active": item.isActive }])
        ...
        createBaseVNode("ul", _hoisted_9$4, [
          withDirectives(createBaseVNode("li", { class: "ums-front-cockpit__chart-persona__legend-item ums-front-cockpit__chart-persona__legend-item--difference" }, " Threshold (set to " + toDisplayString(unref(group).minimumParticipationScoreThreshold) + ") ", 513), [
            [vShow, unref(group).minimumParticipationScoreThreshold]
          ]),
          withDirectives(createBaseVNode("li", {
            class: "ums-front-cockpit__chart-persona__legend-item ums-front-cockpit__chart-persona__legend-item--difference",
...
const _hoisted_1$7 = /* @__PURE__ */ createBaseVNode("strong", { class: "ums-front-cockpit__panel__header" }, "Personas", -1);
const _hoisted_2$7 = { key: 0 };
const _hoisted_3$6 = { key: 1 };
const _hoisted_4$5 = { key: 0 };
const _hoisted_5$5 = { class: "ums-front-cockpit__carrousel" };
const _hoisted_6$5 = ["disabled"];
const _hoisted_7$5 = { class: "ums-front-cockpit__carrousel__center" };
const _hoisted_8$5 = { key: 0 };
const _hoisted_9$3 = ["disabled"];
const _hoisted_10$3 = /* @__PURE__ */ createBaseVNode("span", { class: "ums-front-cockpit__panel__header" }, "Journeys", -1);
...
const _hoisted_15 = {
  key: 1,
  class: "ums-front-cockpit__carrousel"
};
const _hoisted_16 = ["disabled"];
const _hoisted_17 = { class: "ums-front-cockpit__carrousel__center" };
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit }) {
    ...
    const getData = () => {
      const cockpitData = window.__UMS_COCKPIT_DATA;
      if (cockpitData == null)
        return;
      ...
      return openBlock(), createBlock(CockpitPanel, null, {
        default: withCtx(() => [
          ...
          withDirectives(createBaseVNode("div", null, [
            _hoisted_1$7,
            !unref(data).personas || unref(data).personas.personaGroups.length === 0 ? (openBlock(), createElementBlock("p", _hoisted_2$7, " There are no personas configured. ")) : createCommentVNode("", true),
            unref(data).personas && unref(data).personas.personaGroups.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_3$6, [
              unref(data).personas.personaGroups[__props.selectedPersona].personas.length === 0 ? (openBlock(), createElementBlock("p", _hoisted_4$5, " There are no personas added to this persona group. ")) : createCommentVNode("", true),
              ...
              createBaseVNode("div", _hoisted_5$5, [
                withDirectives(createBaseVNode("button", {
                  class: normalizeClass(["ums-front-cockpit__button ums-front-cockpit__button--square", { "s-inactive": __props.selectedPersona === 0 }]),
                  type: "button",
                  ...
                  createVNode(UmsIcon, {
                    icon: "arrow",
                    customclass: "ums-front-icon--xs ums-front-icon--flip-x"
                  })
                ], 10, _hoisted_6$5), [
                ...
                withDirectives(createBaseVNode("button", {
                  class: normalizeClass(["ums-front-cockpit__button ums-front-cockpit__button--square", { "s-inactive": __props.selectedPersona === unref(data).personas.personaGroups.length - 1 }]),
                  type: "button",
            ...
            _hoisted_10$3,
            _hoisted_11$2,
            !unref(data).customerJourneys || unref(data).customerJourneys.customerJourneyGroups.length === 0 ? (openBlock(), createElementBlock("p", _hoisted_12, " There are no journeys configured. ")) : createCommentVNode("", true),
            unref(data).customerJourneys && unref(data).customerJourneys.customerJourneyGroups.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_13, [
              unref(data).customerJourneys.customerJourneyGroups[__props.selectedStep].steps.length === 0 ? (openBlock(), createElementBlock("p", _hoisted_14, " There are no steps added to this journey. ")) : createCommentVNode("", true),
              withDirectives(createVNode(_sfc_main$9, {
              ...
              unref(data).customerJourneys ? (openBlock(), createElementBlock("div", _hoisted_15, [
                withDirectives(createBaseVNode("button", {
                  class: normalizeClass(["ums-front-cockpit__button ums-front-cockpit__button--square", { "s-inactive": __props.selectedStep === 0 }]),
                  type: "button",
                ...
                createBaseVNode("div", _hoisted_17, [
                  unref(data).customerJourneys.customerJourneyGroups[__props.selectedStep] ? (openBlock(), createElementBlock("span", _hoisted_18, toDisplayString(unref(data).customerJourneys.customerJourneyGroups[__props.selectedStep].name), 1)) : createCommentVNode("", true)
                ]),
                withDirectives(createBaseVNode("button", {
                  class: normalizeClass(["ums-front-cockpit__button ums-front-cockpit__button--square", {
...
const _hoisted_1$6 = { class: "ums-front-cockpit__popup__enter ums-front-cockpit__popup__enter--flex" };
const _hoisted_2$6 = {
  key: 0,
  class: "ums-front-cockpit__parameter__icon"
};
const _hoisted_3$5 = {
  key: 1,
  class: "ums-front-cockpit__parameter__negation"
};
const _hoisted_4$4 = /* @__PURE__ */ createBaseVNode("span", null, "not", -1);
const _hoisted_5$4 = [
  _hoisted_4$4
];
const _hoisted_6$4 = { class: "ums-front-cockpit__parameter__text" };
const _hoisted_7$4 = {
  key: 0,
  class: "ums-front-cockpit__parameter__text-wrapper"
};
const _hoisted_8$4 = {
  key: 0,
  class: "ums-front-cockpit__parameter__text--light"
};
const _hoisted_9$2 = {
  key: 0,
  class: "ums-front-cockpit__parameter__text--light"
};
const _hoisted_10$2 = { class: "ums-front-cockpit__popup__holder ums-front-cockpit__popup__holder--offset ums-front-cockpit__popup__holder--no-pointer is-animated" };
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["ums-front-cockpit__parameter__box", { "s-inactive": !__props.rule.isSatisfied }])
      }, [
        createBaseVNode("div", _hoisted_1$6, [
          __props.rule.icon != null ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
            createVNode(UmsIcon, {
              icon: __props.rule.icon,
              customclass: "ums-front-icon--md"
            }, null, 8, ["icon"])
          ])) : createCommentVNode("", true),
          __props.rule.isNegation ? (openBlock(), createElementBlock("div", _hoisted_3$5, _hoisted_5$4)) : createCommentVNode("", true),
...
const _hoisted_1$5 = { class: "ums-front-cockpit__accordion-item" };
const _hoisted_2$5 = { class: "ums-front-cockpit__nav-list__button__title" };
const _hoisted_3$4 = {
  key: 0,
  class: "ums-front-cockpit__accordion-panel"
};
const _sfc_main$6 = {
  props: {
    title: {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        createBaseVNode("button", {
          class: normalizeClass(["ums-front-cockpit__nav-list__button ums-front-cockpit__accordion-trigger", { "s-selected": panelOpen.value }]),
          onClick: _cache[0] || (_cache[0] = ($event) => panelOpen.value = !panelOpen.value)
        }, [
          createBaseVNode("span", _hoisted_2$5, toDisplayString(__props.title), 1),
          __props.description ? (openBlock(), createElementBlock("span", {
            key: 0,
            class: normalizeClass(["ums-front-cockpit__nav-list__button__caret", __props.descriptionStatus]),
          ...
          __props.showCaret ? (openBlock(), createElementBlock("span", {
            key: 1,
            class: normalizeClass(["ums-front-cockpit__nav-list__button__caret static", { "s-active": panelOpen.value }])
          }, [
            createVNode(UmsIcon, {
              icon: "caret",
              customclass: "ums-front-icon--xs"
        ...
        panelOpen.value ? (openBlock(), createElementBlock("div", _hoisted_3$4, [
...
const _hoisted_1$4 = /* @__PURE__ */ createBaseVNode("strong", { class: "ums-front-cockpit__panel__header" }, "Segments with active parameters", -1);
const _hoisted_2$4 = { class: "ums-front-cockpit__segment-group" };
const _hoisted_3$3 = {
  key: 0,
  class: "ums-front-cockpit__balloon",
  style: { "margin-bottom": "10px" }
};
const _hoisted_4$3 = { class: "ums-front-cockpit__parameter__container" };
const _hoisted_5$3 = /* @__PURE__ */ createBaseVNode("strong", {
  class: "ums-front-cockpit__panel__header",
  style: { "margin-top": "40px !important" }
}, "Other segments", -1);
const _hoisted_6$3 = { class: "ums-front-cockpit__segment-group" };
const _hoisted_7$3 = {
  key: 0,
  class: "ums-front-cockpit__balloon",
  style: { "margin-bottom": "10px" }
};
const _hoisted_8$3 = { class: "ums-front-cockpit__parameter__container" };
const _sfc_main$5 = {
  setup(__props) {
    const loading = ref(0);
    const data = ref(null);
            ...
            createBaseVNode("div", _hoisted_2$4, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(segmentsWithActiveParameters), (parameter, index) => {
                return openBlock(), createBlock(_sfc_main$6, {
                  ...
                  default: withCtx(() => [
                    parameter.isInControlGroup ? (openBlock(), createElementBlock("div", _hoisted_3$3, " Part of control group; visitor will not be exposed to personalized content. ")) : createCommentVNode("", true),
        ...
        default: withCtx(() => [
          createVNode(CockpitSubpanelItem, null, {
            default: withCtx(() => [
              ...
              unref(state).ui.subPanels.personalization.implicit ? (openBlock(), createBlock(_sfc_main$8, {
                key: 0,
          ...
          createVNode(CockpitSubpanelItem, null, {
            default: withCtx(() => [
              ...
              unref(state).ui.subPanels.personalization.segments ? (openBlock(), createBlock(_sfc_main$5, { key: 0 })) : createCommentVNode("", true)
            ]),
            _: 1
          })
        ]),
...
const _hoisted_1$3 = {
  class: "ums-front-cockpit__panel__header ums-front-cockpit__panel__header--blue",
...
const _hoisted_3$2 = { class: "ums-front-cockpit__simulation__segments" };
const _hoisted_4$2 = { style: { "opacity": "0.5" } };
const _hoisted_5$2 = { class: "ums-front-cockpit__nav-list__button__caret" };
const _hoisted_6$2 = { class: "ums-front-cockpit__checkboxlist" };
const _hoisted_7$2 = ["value", "disabled"];
const _hoisted_8$2 = { style: { "width": "100%" } };
const _hoisted_9$1 = { class: "ums-front-cockpit__bullet-list" };
const _hoisted_10$1 = {
  key: 0,
  class: "ums-front-cockpit__message-box ums-front-cockpit__message-box--clickable ums-front-icon__wrap",
  style: { "margin-top": "20px" }
};
const _hoisted_11 = {
  class: "ums-front-cockpit__button-container ums-front-cockpit__button-container--end",
  style: { "margin-top": "20px" }
};
const _sfc_main$3 = {
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(CockpitPanel, null, {
        default: withCtx(() => [
          withDirectives(createBaseVNode("span", _hoisted_1$3, "Visit website as segment:", 512), [
            [vShow, !unref(state).simulation.running]
          ]),
          withDirectives(createBaseVNode("span", _hoisted_2$3, "Visiting the website as the following segments:", 512), [
            [vShow, unref(state).simulation.running]
          ]),
          createBaseVNode("div", null, [
            ...
            withDirectives(createBaseVNode("div", null, [
              createBaseVNode("div", {
                class: normalizeClass(["ums-front-cockpit__simulation__select", { "s-open": checkboxListOpen.value }]),
                onClick: toggleCheckboxList
              }, [
                createBaseVNode("div", _hoisted_3$2, [
                  withDirectives(createBaseVNode("span", _hoisted_4$2, "Select a segment", 512), [
                ...
                createBaseVNode("span", _hoisted_5$2, [
                  withDirectives(createVNode(UmsIcon, {
                    icon: "arrow-light",
                    customclass: "ums-front-icon--xs"
                  }, null, 512), [
                  ...
                  withDirectives(createVNode(UmsIcon, {
                    icon: "arrow-light",
                    customclass: "ums-front-icon--xs ums-front-icon--flip-y"
                  }, null, 512), [
                    [vShow, checkboxListOpen.value]
                  ])
                ])
          ...
          createBaseVNode("div", _hoisted_11, [
            createVNode(UmsButton, {
              ...
              look: `ums-front-cockpit__button--large ${unref(state).simulation.running && unref(state).simulation.segments.length > 0 ? "ums-front-cockpit__button--error-bg" : "ums-front-cockpit__button--success"}`,
...
const _hoisted_1$2 = { class: "ums-front-cockpit__panel__content" };
const _hoisted_2$2 = { class: "ums-front-cockpit__panel__content" };
const _hoisted_3$1 = { class: "ums-front-cockpit__panel__content" };
const _hoisted_4$1 = {
  class: "ums-front-cockpit__panel__section",
  style: { "margin-top": "10px" }
};
const _hoisted_5$1 = { class: "ums-front-cockpit__table-simple ums-front-cockpit__table-simple--align-start" };
const _hoisted_6$1 = {
  class: "ums-front-cockpit__panel__section",
...
const _hoisted_8$1 = { class: "ums-front-cockpit__table-simple ums-front-cockpit__table-simple--align-start" };
const _hoisted_9 = {
  key: 0,
  class: "ums-front-cockpit__panel__section",
  style: { "margin-top": "40px" }
...
const _sfc_main$2 = {
  setup(__props) {
    ...
    const getData = () => {
      ...
      loading.value = true;
      getJSON("/umbraco/umarketingsuite/cockpitapi/GetUmbracoPageInfo?pageId=" + state.value.page.id + "&culture=" + state.value.page.culture, (response) => {
        data.value = response;
        loading.value = false;
      }, () => loading.value = false);
    };
    ...
    const dataEditor = computed(() => {
      if (data.value) {
        ...
        if (dataClone && dataClone.createdDate) {
          dataClone.createdDate = umsDate(dataClone.createdDate);
        }
        if (dataClone && dataClone.editedDate) {
          dataClone.editedDate = umsDate(dataClone.editedDate);
        }
        return dataClone;
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(CockpitPanel, null, {
        default: withCtx(() => [
          ...
          withDirectives(createBaseVNode("div", _hoisted_2$2, " Data not available ", 512), [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(dataWithoutEditor), (value, key) => {
                    return openBlock(), createElementBlock("tr", { key }, [
                      ...
                      createBaseVNode("td", null, [
                        createBaseVNode("span", {
                          class: normalizeClass({
                            "ums-front-cockpit__banner": key === "status",
                            "ums-front-cockpit__banner--success": key == "status" && value == "Published"
                          })
            ...
            data.value && data.value.url ? (openBlock(), createElementBlock("div", _hoisted_9, [
              createBaseVNode("div", _hoisted_10, [
                createVNode(UmsButton, {
                  ...
                  target: "_blank",
                  icon: "arrow",
                  look: "ums-front-cockpit__button--large ums-front-cockpit__button--base"
                }, null, 8, ["to"])
              ])
            ])) : createCommentVNode("", true)
          ], 512), [
...
const _sfc_main$1 = {
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(CockpitPanel, null, {
        default: withCtx(() => [
          profileUrl.value ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
            createVNode(UmsButton, {
          ...
          ])) : (openBlock(), createElementBlock("span", _hoisted_2$1, "Profile information not available"))
        ]),
        _: 1
      });
    };
...
var UmsCockpit_vue_vue_type_style_index_0_lang = "";
var UmsCockpit_vue_vue_type_style_index_1_scoped_true_lang = "";
var UmsCockpit_vue_vue_type_style_index_2_lang = "";
const _hoisted_1 = ["data-cockpit-position", "data-cockpit-pip"];
const _hoisted_2 = {
  key: 0,
  class: "ums-front-cockpit__main"
};
const _hoisted_3 = { class: "ums-front-cockpit__header" };
const _hoisted_4 = { class: "ums-front-cockpit__header__logo" };
const _hoisted_5 = { class: "ums-front-cockpit__header__buttons" };
const _hoisted_6 = { class: "ums-front-cockpit__button-container" };
...
const _sfc_main = {
  setup(__props) {
    const state = useGlobalState();
    onBeforeMount(() => {
      const data = window.__UMS_COCKPIT_DATA;
    ...
    const renderPanel = computed(() => {
      var _a2;
      const panels = {
        analytics: _sfc_main$a,
        personalization: _sfc_main$4,
        simulationmode: _sfc_main$3,
        pageinfo: _sfc_main$2,
        profile: _sfc_main$1
      };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "ums-front-cockpit loaded",
            ...
            unref(state).ui.open ? (openBlock(), createElementBlock("div", _hoisted_2, [
              createBaseVNode("header", _hoisted_3, [
                createBaseVNode("div", _hoisted_4, [
                  createVNode(UmsIcon, {
                    icon: "logo",
                    customclass: "ums-front-cockpit__header-logo__image"
                  })
                ]),
                createBaseVNode("div", _hoisted_5, [
                  createBaseVNode("div", _hoisted_6, [
                    createBaseVNode("button", {
                      class: normalizeClass(["ums-front-cockpit__button ums-front-cockpit__button--square", { "s-active": unref(state).ui.position == "left" }]),
                      type: "button",
                    ...
                    createBaseVNode("button", {
                      class: normalizeClass(["ums-front-cockpit__button ums-front-cockpit__button--square", { "s-active": unref(state).ui.position == "right" }]),
                      type: "button",
                      ...
                      createVNode(UmsIcon, {
                        icon: "panel-align",
                        customclass: " ums-front-icon--sm ums-front-icon--flip-x"
                      })
                    ], 2)
                  ]),
                  createVNode(UmsButton, {
              ...
              createBaseVNode("div", {
                ...
                class: normalizeClass(["ums-front-cockpit__drag-indicator", { "s-dragging": unref(pressed) }]),
...
var UmsCockpit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7ff6cd3a"]]);
var style = "";
createApp(UmsCockpit).mount("#ums-cockpit");
